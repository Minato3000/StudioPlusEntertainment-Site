...
<footer class="text-center lg:text-left bg-gradient-to-t from-green-500 to-emerald-500 text-black">
    <div class="flex justify-center items-center lg:justify-between p-6 border-b border-green-600">
      <div class="flex justify-center mr-12 text-center hidden lg:block">
        <span>Studio Plus Entertainment</span>
      </div>
    </div>
